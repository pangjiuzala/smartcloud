...
public class ManagertoUserActivity extends Activity {
	...
	public boolean onKeyDown(int keyCode, KeyEvent event) {
		...
		if (keyCode == KeyEvent.KEYCODE_BACK) {
			...
			Assist.transActivity(ManagertoUserActivity.this,
...
//				WindowManager.LayoutParams.FLAG_FULLSCREEN);
		...
		MyActivityManager.addActivity(ManagertoUserActivity.this);
				...
				, new OnClickListener() {
					...
					public void onClick(DialogInterface dialog, int which) {
						...
						progressDialog = ProgressDialog.show(
								ManagertoUserActivity.this, "验证中", "请您稍后...",
								false, true);
