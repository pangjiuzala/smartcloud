...
public class StaffDeleteActivity extends Activity {
	...
	public boolean onKeyDown(int keyCode, KeyEvent event) {
		...
		if (keyCode == KeyEvent.KEYCODE_BACK) {
			...
			Assist.transActivity(StaffDeleteActivity.this,
...
//				WindowManager.LayoutParams.FLAG_FULLSCREEN);
		...
		MyActivityManager.addActivity(StaffDeleteActivity.this);
				...
				, new OnClickListener() {
					...
					public void onClick(DialogInterface dialog, int which) {
						...
						progressDialog = ProgressDialog.show(
								StaffDeleteActivity.this, "注销中", "请您稍后...",
								false, true);
								...
								try {
									...
									ResultSet rs = s
											.executeQuery("select * from  tpl_members where member_id ="
													...
													+ nums);
									if (rs.next()) {
										s.executeUpdate("delete from  tpl_members where member_id ="
												+ nums
												+ " or id="
												+ nums
