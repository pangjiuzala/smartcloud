...
public class ManagertoClearActivity extends Activity {
	...
	public boolean onKeyDown(int keyCode, KeyEvent event) {
		...
		if (keyCode == KeyEvent.KEYCODE_BACK) {
			...
			Assist.transActivity(ManagertoClearActivity.this,
...
//				WindowManager.LayoutParams.FLAG_FULLSCREEN);
		...
		MyActivityManager.addActivity(ManagertoClearActivity.this);
				...
				, new OnClickListener() {
					...
					public void onClick(DialogInterface dialog, int which) {
						...
						progressDialog = ProgressDialog.show(
								ManagertoClearActivity.this, "验证中", "请您稍后...",
								false, true);
