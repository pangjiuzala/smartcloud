...
public class ManagertoClearIpActivity extends Activity {
	...
	public boolean onKeyDown(int keyCode, KeyEvent event) {
		...
		if (keyCode == KeyEvent.KEYCODE_BACK) {
			...
			Assist.transActivity(ManagertoClearIpActivity.this,
...
//				WindowManager.LayoutParams.FLAG_FULLSCREEN);
		...
		MyActivityManager.addActivity(ManagertoClearIpActivity.this);
				...
				, new OnClickListener() {
					...
					public void onClick(DialogInterface dialog, int which) {
						...
						progressDialog = ProgressDialog.show(
								ManagertoClearIpActivity.this, "验证中", "请您稍后...",
								false, true);
