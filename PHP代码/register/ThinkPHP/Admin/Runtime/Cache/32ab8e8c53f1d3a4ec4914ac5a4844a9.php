				...
				<td width="182" valign="top"><div id="container"> 
				 ...
				 <!--会员管理-->
				  ...
				  <div class="content">
					...
					<ul class="MM">
					  <li><a href="__APP__/Member/index" target="main">会员信息</a></li>
					  <li><a href="__APP__/Member/addMem" target="main">添加会员</a></li>
					  <li><a href="__APP__/Member/searchMem" target="main">搜索会员</a></li>
					</ul>
				  </div>
				   <!--会员管理-->
				  ...
				  <h1 class="type"><a href="javascript:void(0)">考勤管理</a></h1>
				  <div class="content">
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
					  <tr>
						<td><img src="__PUBLIC__/images/menu_topline.gif" width="182" height="5" /></td>
					...
					<ul class="MM">
					  <li><a href="__APP__/ExamRecord/examConfig" target="main">设置考勤配置</a></li>
					  <li><a href="__APP__/ExamRecord/index" target="main">考勤配置信息</a></li>
					</ul>
				  </div>
				</div>
				<!--考勤管理-->
